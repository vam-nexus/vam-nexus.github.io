                    ...
                    const formattedQuestion = question.question.replace(
                        ...
                        (match, codeContent) => {
                            ...
                            const formattedLines = lines.map(line => {
                                ...
                                // Add proper indentation (4 spaces for Python)
                                // You can adjust the indentation logic based on your needs
                                if (trimmedLine.startsWith('def ') || trimmedLine.startsWith('class ')) {
                                    ...
                                    return '    ' + trimmedLine;  // 4 spaces indentation
                                }
                                return trimmedLine;
                            }).join('\n');
                            
                            return `<pre><code class="language-python">${formattedLines}</code></pre>`;
                        }
                    );

                    questionDiv.innerHTML = `
                        <div class="question">${index}. ${formattedQuestion}</div>
                        <div class="choices">
